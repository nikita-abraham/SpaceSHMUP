...
public class Enemy_1 : Enemy {
	//because Enemy_1 extends Enemy, the _______ bool won't work
	// the same way in the Inspector Pane 

	//the number of seconds for a full sine wave
	public float waveFrequency = 2;
	//sine wave width in meters
	public float waveWidth = 4;
	public float waveRotY = 45;

	private float xO = -12345; // the initial x value of pos
	private float birthTime;

	void Start() {
		//set xO to the initial x position of Enemy_1
	...
	public override void Move() {
		//because pos is a prperty, you can't directly set pos.x
